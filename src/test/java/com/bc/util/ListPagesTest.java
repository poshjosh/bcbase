 ...
 * @author Josh
 */
public class ListPagesTest {
    
    private List alphabets;
    private List numbers;
    private List names;
    
    public ListPagesTest() { }
    ...
    private ListPages getDefaultInstance() {
        ListPages instance = new ListPages(alphabets, numbers, names);
        return instance;
    }
    /**
     * Test of getPageAt method, of class ListPages.
     */
    @Test
    public void testGetPageAt() {
        ...
        final ListPages instance = this.getDefaultInstance();
    ...
    /**
     * Test of getPageFor method, of class ListPages.
     */
    @Test
    ...
    /**
     * Test of get method, of class ListPages.
     */
    @Test
    public void testGet() {
    ...
    /**
     * Test of size method, of class ListPages.
     */
    @Test
    public void testSize() {
        ...
        instance = new ListPages(this.alphabets, this.numbers, this.names);
        
        int expResult = this.alphabets.size() + this.numbers.size() + this.names.size();
        int result = instance.size();
        assertEquals(expResult, result);

        instance = new ListPages(this.alphabets, this.numbers);
    ...
    /**
     * Test of remove method, of class ListPages.
     */
    @Test
    ...
    /**
     * Test of add method, of class ListPages.
     */
    @Test
    public void testAdd() {
...
//        assertEquals(expResult, this.numbers);
    ...
    /**
     * Test of set method, of class ListPages.
     */
    @Test
    public void testSet() {
