...
XLogger.getInstance().log(Level.FINER, "#generate(URL, String)", this.getClass());
        
        ScriptEngineManager manager = new ScriptEngineManager();
        ScriptEngine engine = manager.getEngineByName("JavaScript");

XLogger.getInstance().log(Level.FINE, "Script Engine: {0}", this.getClass(), engine);
...
XLogger.getInstance().log(Level.FINE, "Raw operation: {0}, challenge pass: {1}, challenge: {2}", 
...
XLogger.getInstance().log(Level.FINE, "Output parameters: {0}", this.getClass(), CloudFlareResponseParameters.this);
    }
}
/**
 * 
